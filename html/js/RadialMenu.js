...
RadialMenu.prototype.close = function () {
    ...
    if (self.currentMenu) {
        $.post(`http://${GetParentResourceName()}/closeRadial`);
        var parentMenu;
...
RadialMenu.prototype.createMenu = function (classValue, levelItems, nested) {
    ...
    stop1.setAttribute('style', 'stop-color:rgba(0, 178, 255, 0.20); stop-opacity:1');

    var stop2 = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
    stop2.setAttribute('offset', '100%');
    stop2.setAttribute('style', 'stop-color:rgba(0, 178, 255, 0.20); stop-opacity:1');
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
RadialMenu.prototype.createTextTag = function (x, y, link) {
    var text = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    text.setAttribute('x', x);
    text.setAttribute('y', y);
    text.setAttribute('class', link); // assuming link is the class for the icon font
    text.textContent = '\uf007'; // Unicode character for the icon (example: user icon in Font Awesome)
    text.setAttribute('font-family', 'FontAwesome'); // Set the font-family to your icon font
...
RadialMenu.prototype.appendSectorPath = function (startAngleDeg, endAngleDeg, svg, item, index) {
    ...
    if (item) {
        ...
        if (item.icon) {
            ...
            var use = self.createIconElement(centerPoint.x, centerPoint.y, item.icon)
            if (item.title) {
                use.setAttribute('transform', 'translate(-4,-15)');
            } else {
                use.setAttribute('transform', 'translate(-4,-12)');
            }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
RadialMenu.prototype.createIconElement = function (x, y, link) {
    ...
    if (link.includes('fa-')) {
        ...
        i.setAttribute('class', link);
        i.style.fontSize = '0.8vh';
        i.style.color = 'white';
    
        div.appendChild(i);
    } else {
        var img = document.createElement('img');
        img.setAttribute('src', `icons/${link}.svg`);
        img.style.width = '0.8vh';
        div.appendChild(img);
    }
